const API_BASE = import.meta.env.VITE_API_URL || "https://thinkcode-backend11-production.up.railway.app/api" || "http://localhost:5000/api"; // Default dengan /api untuk API calls
